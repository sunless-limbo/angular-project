        ...
        this.weatherApiService
          ...
          .subscribe((res) => {
            this.forecastDataJson = [
              ...
              {
                date: `${res.list[5].dt_txt}`,
                icon: `http://openweathermap.org/img/wn/${res.list[5].weather[0].icon}@2x.png`,
                weather: `${res.list[5].weather[0].main}`,
                description: `${res.list[5].weather[0].main}`,
                clouds: res.list[5].clouds.all,
                pressure: res.list[5].main.pressure,
                humidity: res.list[5].main.humidity,
                wind: res.list[5].wind.speed,
                temperature: res.list[5].main.temp,
              },
              {
                date: `${res.list[6].dt_txt}`,
                icon: `http://openweathermap.org/img/wn/${res.list[4].weather[0].icon}@2x.png`,
                weather: `${res.list[6].weather[0].main}`,
                description: `${res.list[6].weather[0].main}`,
                clouds: res.list[6].clouds.all,
                pressure: res.list[6].main.pressure,
                humidity: res.list[6].main.humidity,
                wind: res.list[6].wind.speed,
                temperature: res.list[6].main.temp,
              },
              {
                date: `${res.list[7].dt_txt}`,
                icon: `http://openweathermap.org/img/wn/${res.list[7].weather[0].icon}@2x.png`,
                weather: `${res.list[7].weather[0].main}`,
                description: `${res.list[7].weather[0].main}`,
                clouds: res.list[7].clouds.all,
                pressure: res.list[7].main.pressure,
                humidity: res.list[7].main.humidity,
                wind: res.list[7].wind.speed,
                temperature: res.list[7].main.temp,
              },
              {
                date: `${res.list[8].dt_txt}`,
                icon: `http://openweathermap.org/img/wn/${res.list[8].weather[0].icon}@2x.png`,
                weather: `${res.list[8].weather[0].main}`,
                description: `${res.list[8].weather[0].main}`,
                clouds: res.list[8].clouds.all,
                pressure: res.list[8].main.pressure,
                humidity: res.list[8].main.humidity,
                wind: res.list[8].wind.speed,
